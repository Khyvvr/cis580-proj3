...
{
    public struct BoundingRectangle //from cis 580 inclass work, done by Professor Bean
    {
        /// <summary>
        ...
        public bool Collides(BoundingRectangle br, float pos)
        {
            return !(this.X > pos + br.Width)
                || (this.X + this.Width < pos)
                || (this.Y > pos + br.Height)
